...
export default function MasteredChartPhrases({ username }: { username: string | null }) {
  ...
  useEffect(() => {
    ...
    fetch(`/api/stats/daily-mastered-phrases?username=${encodeURIComponent(username)}`)
      .then((r) => r.json())
      .then((json) => {
